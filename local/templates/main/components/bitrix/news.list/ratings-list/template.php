...
<?
   ...
   <? if(!empty($arItem['PROPERTIES']['REKVISITS']['DESCRIPTION'])){?>
           ...
           <?foreach($arItem['PROPERTIES']['REKVISITS']['DESCRIPTION'] as $key=> $item){?>
            ...
            <div class="lr-table__row">
                ...
                <div class="lr-table__col lr-table__right">
                   <?=$arItem['PROPERTIES']['REKVISITS']['VALUE'][$key]['TEXT'];?>
                </div>
            </div>
            <?}?>
        </div>
            ...
            <div class="lr-table">
               <?foreach($arItem['PROPERTIES']['PAY_REKVISITS']['DESCRIPTION'] as $key=> $item){?>
                ...
                <div class="lr-table__row">
                    ...
                    <div class="lr-table__col lr-table__right">
                       <?=$arItem['PROPERTIES']['PAY_REKVISITS']['VALUE'][$key]['TEXT'];?>
                    </div>
                </div>
                <?}?>
            </div>
    ...
    <?}?>
    <? if(!empty($arItem['PROPERTIES']['BANNER']['VALUE'])){
         $url = CFile::GetPath($arItem['PROPERTIES']['BANNER']['VALUE']);                                                  
    ?>
    <div class="section section_default section_b-l-offset section_gray">
        <div class="wrapper wrapper_default">
           <?if(!empty($arItem['PROPERTIES']['BANNER']['DESCRIPTION'])){?>
           <a href="<?=$arItem['PROPERTIES']['BANNER']['DESCRIPTION'];?>" class="single-banner">
           <?}else{?>
