...
foreach ($arResult["PROPERTIES"]["ADVANTAGES1_IMAGE"]["VALUE"] as $keyAdvantages => $idAdvantages) {
  $arResult["PROPERTIES"]["ADVANTAGES1_IMAGE"]["VALUE"][$keyAdvantages] = CFile::GetFileArray($idAdvantages);
}
foreach ($arResult["PROPERTIES"]["ADVANTAGES3_IMAGE"]["VALUE"] as $keyAdvantages => $idAdvantages) {
  $arResult["PROPERTIES"]["ADVANTAGES3_IMAGE"]["VALUE"][$keyAdvantages] = CFile::GetFileArray($idAdvantages);
}