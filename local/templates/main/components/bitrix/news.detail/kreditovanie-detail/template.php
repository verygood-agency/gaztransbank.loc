                ...
                <div class="col col--lg-7">
                    ...
                    <h4 class="h4 page-desc title title_light">
                      <div class="preview-kredit content">
                        ...
                        <?if ($arResult['PROPERTIES']['PREVIEW_LIST']['VALUE']) {
                          if (count($arResult['PROPERTIES']['PREVIEW_LIST']['VALUE']) > 1) {?>
                          <div class="row">
                            <?foreach($arResult['PROPERTIES']['PREVIEW_LIST']['VALUE'] as $list){?>
                    ...
                    <a data-title="Заявка на кредит" href="#product-open-credit-<?php echo $arResult['ID']; ?>" class="inline-t-popup btn btn_default btn-bordered_red">Отправить заявку</a>
                </div>
...
<?if ($arResult['PROPERTIES']['CALCULATOR']['VALUE']) {
    $calc = \Local\Calcs\AbstractCalc::make('fl_credit', $_GET['days'], $_GET['type'], $arResult['ID']);
}?>
<?php include $_SERVER['DOCUMENT_ROOT']."/local/calcs/kredit2.php"; ?>
