...
$eventName = 'FORM_FEEDBACK_CORRUPTION';
...
if (check_bitrix_sessid('sessid_feedback_popup') || check_bitrix_sessid('sessid_feedback') || check_bitrix_sessid()) {
    ...
    if ($request->isAjaxRequest()) {
        if (
          ($_REQUEST['anonymous'] == "no" && $_REQUEST['name'] && $_REQUEST['phone'] && $_REQUEST['email']) ||
          $_REQUEST['anonymous'] == "yes"
        ) {
