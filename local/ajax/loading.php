<?
//Скрипт загрузки файлов переданных в формах
if ($_GET['filename'] && strpos(htmlspecialchars($_GET['filename']) ,'/upload/mail_attachments/') !== FALSE) {
  $filename = $_SERVER['DOCUMENT_ROOT'] . htmlspecialchars($_GET['filename']);
